...
export function validateCatalog(
  ...
  // The version promise is checked for every registry at once, by
  // `validateCatalogFingerprints`: it was kept here, for the equipment
  // catalogue alone, while five other registries versioned nothing.
  return issues;
}
