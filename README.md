...
![Version 0.3.0-beta.8](https://img.shields.io/badge/version-0.3.0--beta.8-yellow)
![Statut bêta](https://img.shields.io/badge/statut-b%C3%AAta-yellow)

> **Version 0.3.0-beta.8 — bêta.** L'application couvre le parcours complet et
...
**Version 0.3.0-beta.8, bêta.** L'application couvre le parcours complet :
...
Cette liste décrit la `0.3.0-beta.8` telle qu'elle est aujourd'hui, et rien
