...
![Version 0.3.0-beta.13](https://img.shields.io/badge/version-0.3.0--beta.13-yellow)
![Statut bêta](https://img.shields.io/badge/statut-b%C3%AAta-yellow)

> **Version 0.3.0-beta.13 — bêta.** L'application couvre le parcours complet et
...
```bash
npm run catalog:status        # où en est chacune des 527 familles
...
**Version 0.3.0-beta.13, bêta.** L'application couvre le parcours complet :
...
Cette liste décrit la `0.3.0-beta.13` telle qu'elle est aujourd'hui, et rien
